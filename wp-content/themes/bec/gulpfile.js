...
// Project related.
var project                 = 'bec'; // Project Name.
var projectURL              = 'www.bec.local'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'bec'; // Your textdomain here.
var translationFile         = 'bec.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'bec'; // Package name.
var bugReport               = ''; // Where can users report bugs.
var lastTranslator          = 'Antonio Pistilli <antonio.pistilli@lift-d.com>'; // Last translator Email ID.
var team                    = 'Lift-d <webmaster@lift-d.com>'; // Team's Email ID.
